...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
            ...
            <form method="post" action="sliderCreate.php" enctype="multipart/form-data" data-parsley-validate>
                <!-- Input  -->
                <div class="row">
                    <div class="col-md-4 mg-b-10">
                        <label class="form-control-label">Product Name: <span class="tx-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Slider Product Name" name="productName" required>

                    </div><!-- col end-->

                    <div class="col-md-4 mg-b-10">
                        <label class="form-control-label">Product code: <span class="tx-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Slider Product Code" name="productCode" required>

                    </div><!-- col end-->

                    <div class="col-md-4 mg-b-10">
                        <label class="form-control-label">Product In Stock: <span class="tx-danger">*</span></label>
                        <input type="number" min="0" class="form-control" placeholder="Enter Slider Product In Stock" name="productInStock" required>
                    ...
                    <div class="col-md-4 mg-b-10">
                        ...
                        <input type="number" min="0" class="form-control" placeholder="Enter Slider Product Regular Price" name="productPrice" required>
                    </div><!-- col end-->
                    ...
                    <div class="col-md-6 mg-b-10">
                        ...
                        <textarea type="text" class="form-control" placeholder="Enter Slider Product Short Description" rows="10" name="productShortDes" required></textarea>
                    </div><!-- col end-->

                    <div class="col-md-6 mg-b-10">
                        <label class="form-control-label">Product Long Description: <span class="tx-danger">*</span></label>
                        <textarea type="text" class="form-control" placeholder="Enter Slider Product Long Description" rows="10" name="productLongDes" required></textarea>
                    </div><!-- col end-->
