...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Slider Trash List</span>
    </nav>

    <div class="sl-pagebody">
        <div class="sl-page-title text-center text-uppercase">
            <h5>Slider Trash List</h5>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="sliderTrash.php?productId=<?= $product['productId']; ?>" class="btn btn-info">Recover</a></td>
                                    <td>
    ...
    <div id="modaldemo2" class="modal fade rounded">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content bd-0 tx-14">
                ...
                <form action="sliderTrash.php" method="post">
