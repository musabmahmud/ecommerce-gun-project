            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="copyright sm-t-center">
                        <p>Copyright © 2022 <a href="#"><span>Gun</span> </a>Shop. Design by <a href="https://www.fiverr.com/musabmahmud"><span>MD MUSAB MAHMUD</span></a></p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
...
<script>
    ...
    function getVal() {
        ...
        var selectValue = document.getElementById("shippingId").value;
        document.getElementById("delivery").innerText = selectValue;
    }
</script>
