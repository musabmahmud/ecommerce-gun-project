...
<?php
$sliders = $front->getSlider();
$sliderPdt = $front->getSliderPdt();
?>
        ...
        <div class="row">
            <div class="col-sm-12 pd-0">
                <div class="item-content">
                    ...
                    ?>
                            <div class="item-slider items1 bg-img" style="background: url('assets/images/products/<?= $slider['productImage'] ?>');">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="contents text-center">
                                                <h2 class="wow animated fadeInUp" data-wow-duration="1s"><?= $slider['productName'] ?></h2>
                                                <p class="mr-lu mr-ru wow animated fadeInDown" data-wow-duration="1.5s"><?= $slider['productShortDes'] ?></p>
                                                <div class="buttons wow animated fadeInUp" data-wow-duration="2s">
                                                    <a class="btn1" href="products.php?product-name=<?= $slider['slug']; ?>">shop now</a>
                                                    <a href="products.php?product-name=<?= $slider['slug']; ?>" class="btn2">read more</a>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-sm-12">
                    <div class="item-thumbnail">
                        ...
                        if ($sliders) {
                            ...
                            foreach ($sliders as $slider) {
                        ?>
                                <a href="" class="col-sm-3" data-slide-index="<?= $i++ ?>">
                                    <div class="items">
                                        <div class="dbox">
                                            <div class="dleft">
                                                <figure><img src="assets/images/products/<?= $slider['productImage'] ?>" alt="<?= $slider['productName'] ?>"></figure>
                                            </div>
                                            <div class="dright">
                                                <div class="content">
                                                    <h3><?= $slider['productName'] ?></h3>
                                                    <p>$<?= $slider['productPrice'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 hidden-sm hidden-xs">
                <div class="banner-img">
                    <figure><img src="assets/images/banner/1.png" alt="" /></figure>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="heading1">
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="cnc">
                                ...
                                <ul>
                                    <li><i class="far fa-calendar"></i><span>July 25, 2017</span></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 pd-0">
                <div class="pro-sliders">
                    <?php if($sliderPdt){
                        foreach($sliderPdt as $pdt){
                    ?>
                    <div class="col-sm-12">
                        <div class="products">
                            <figure><img src="assets/images/products/<?= $pdt['productImage']?>" height="220" width="260" alt="<?= $pdt['productName']?>" /></figure>
                            <div class="contents">
                                <h3><?= $pdt['productName']?></h3>
                                <span>$<?= $pdt['productOfferPrice']?></span>
                                <a href="products.php?product-name=<?= $pdt['slug']; ?>" class="btn4">View Details</a>
                            </div>
                        </div>
                    </div>
                    <?php 
            ...
            <div class="col-md-12 col-sm-12">
                <div class="load-btn text-center mr-t80">
                    <a href="shop.php" class="btn1">View All</a>
                </div>
            </div>
        </div>
    </div>
